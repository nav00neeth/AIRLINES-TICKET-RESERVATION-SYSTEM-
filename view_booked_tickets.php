...
<html>
	...
	<body>
		<div class="card bg-dark text-white">
			<img src="images\viewtbbg.png" class="card-img" alt="...">
			<div class="card-img-overlay">
			<br><br>
			<div class="container col col-lg-5 col-xl-5">
				<div class="btn-group">
					<a href="customer_homepage.php" class="btn btn-light" style="width:150px; margin-left: 50px;">Home</a>
					<a href="customer_homepage.php" class="btn btn-light" style="width:150px; margin-left: 50px;">Dashboard</a>
					<a href="logout_handler.php" class="btn btn-light" style="width:150px; margin-left: 50px;">Logout</a>
				</div>
			</div>
				<br><br><br>
				...
				<?php
					...
					echo "<br><br><h3 class=\"set_nice_size\"><center><u>Completed Trips</u></center></h3>";
