            ...
            <form id="index" action="pnrall.php" method="post">
                <div class="container">
                    <div class="col col-lg-11">
                        ...
                        <input type="submit" id="u_sub" name="u_sub" value="Check" class="toggle btn btn-primary" style="width:100px; margin-left: 70px;">
                        <a class="btn btn-primary" href="index.php" role="button" style="width:100px; margin-left: 70px;">Back</a><br>
                        </center>
                    </div>
                </div>
            </form>
